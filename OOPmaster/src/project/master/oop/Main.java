...
public class Main {
    public static void main(String[] args) {
        BaseHamburger hamburger = new BaseHamburger("Regular","white", "chicken", 5);
        hamburger.addIngredient1("Carrot", 0.2);
        hamburger.addIngredient2("TOMATO",0.5);
        hamburger.addIngredient3("leTTUCE", 0.2);
        hamburger.addIngredient4("ketchup", 1);
        hamburger.addIngredient5("mayo", 2);
        double hamburgerPrice = hamburger.burgerPriceWithAndWithoutAdditions();
        
        if (hamburgerPrice > hamburger.getPrice()) {
            System.out.println("The burger: " + "A " + hamburger.getMeat() + " " + hamburger.getName().toLowerCase()
                    + " with " + hamburger.getBread() + " bread "
                    + "costs " + "extra with each addition = " + hamburgerPrice);
        } else {
            System.out.println("The burger: " + "A " + hamburger.getMeat() + " " + hamburger.getName().toLowerCase()
                    + " with " + hamburger.getBread() + " bread "
        ...
        HealthyBurger healthyBurger = new HealthyBurger("Pork", 5);
        healthyBurger.addIngredient1("cashew", 2);
        healthyBurger.addIngredient2("avocado", 2);
        double burgerPrice = healthyBurger.burgerPriceWithAndWithoutAdditions();
        System.out.println("The burger: " + burgerPrice);

        DeluxeHamburger deluxeHamburger = new DeluxeHamburger();
        deluxeHamburger.addIngredient1("carrot",2);
        deluxeHamburger.addIngredient2("levak", 4);
        deluxeHamburger.addIngredient4("lettuce", 4);
