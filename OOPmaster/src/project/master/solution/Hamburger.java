...
public class Hamburger {
    ...
    // Adding ingredients, and their cost
    ...
    public double itemizeHamburger() {
        // obtain the hamburgerPrice without additions
        double hamburgerPrice = this.price;

        // validating additions, and adding to the burger price
